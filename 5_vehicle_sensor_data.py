'''
An app where we can pick things from either a dropdown or a radio dial and visualize it.
We should be able to add or remove charts and those charts should be sized appropiately.
Data needs to be graphed live.
'''
...
# define the app and specify a dictionary for datapoints
